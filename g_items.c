...
void SpawnItem (edict_t *ent, gitem_t *item)
{
	...
	if (deathmatch->value)
	{
		...
		if (!(int)allow_powerscreen->value)
		{
		...
		if (!(int)allow_powershield->value)
		{
		...
		if (!(int)allow_jacketarmor->value)
		{
		...
		if (!(int)allow_combatarmor->value)
		{
